...
MIN_TRADE_VALUE = 11.0       # Minimum trade value in base currency (11$ minimum)
...
MIN_ORDER_VALUE_TOLERABLE = 11.0  # Minimum acceptable order value (11$ minimum)
MIN_ORDER_VALUE_ABSOLUTE = 11.0    # Absolute minimum order value (11$ minimum, non-negotiable)
