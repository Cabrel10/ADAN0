...
class ActionTranslator:
    ...
    def translate_action(self, action: np.ndarray, portfolio_manager, current_prices: dict[str, float]) -> list[dict]:
        ...
        for i, asset in enumerate(self.assets):            
            ...
            # Buy signal (plus sensible)
            if action_value > 0.1:  # Au lieu de 0.5 pour être plus sensible  
            ...
            # Sell signal (plus sensible)
            elif action_value < -0.1:  # Au lieu de -0.5 pour être plus sensible
