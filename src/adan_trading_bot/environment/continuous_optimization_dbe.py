...
from .adaptive_dbe import AdaptiveDBE, DBEParameters
...
class AutoAdjustmentSystem:
    ...
    def __init__(self, adjustment_sensitivity: float = 0.1):
        """Initialise le système d'auto-ajustement.
        
        Args:
            adjustment_sensitivity: Sensibilité des ajustements (0.0 à 1.0)
        """
        self.adjustment_sensitivity = max(0.0, min(1.0, adjustment_sensitivity))
