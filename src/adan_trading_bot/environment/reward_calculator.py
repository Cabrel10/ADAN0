...
class RewardCalculator:
    ...
    def calculate(
        ...
        if (
            ...
            if chunk_id != self.current_chunk_id:
                ...
                if (
                    ...
                    bonus = self.optimal_trade_bonus * (
                        performance_ratio - self.performance_threshold
                    )
                    reward += bonus
        ...
        episode_data = {
            ...
            "performance_bonuses": sum(
                1 for r in self.chunk_rewards.values() if r.get("bonus", 0) > 0
            ),
        ...
        logger.info(
            f"Episode {self.current_episode_id - 1} finalized: "
