...
def main():
    ...
    # Create PPO model -- clamp n_steps so at least 1 rollout fits in total_timesteps
    n_steps = min(agent_cfg.get("n_steps", 512), args.steps)
    n_steps = max(n_steps, 64)  # minimum viable rollout
    ...
    logger.info("=" * 70)
    logger.info("ADAN Simple PPO Training")
