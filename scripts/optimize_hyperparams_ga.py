...
if __name__ == "__main__":
    ...
    logger.info("Starting Optuna hyperparameter optimization study with GA and Pruning...")
    
    # Create an Optuna study to maximize Sharpe Ratio with a Pruner and GA Sampler
    study = optuna.create_study(
        direction="maximize",
        storage="sqlite:////home/morningstar/Documents/trading/bot/hyperparam_optimization.db",
        sampler=NSGAIISampler(),
        study_name="adan_trading_bot_ga_optimization",
